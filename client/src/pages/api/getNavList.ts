...
interface MenuItem {
   ...
   function generateMenuData(): MenuItem[] {
     ...
     const files: string[] = readdirSync(pagesDir)
     ...
     const subdirectories: string[] = readdirSync(pagesDir, { withFileTypes: true })
     ...
     subdirectories.forEach((directory) => {
       ...
       const subdirectoryFiles = readdirSync(subdirectoryPath)
         .filter((file) => file.endsWith('.tsx') || file.endsWith('.jsx'));
